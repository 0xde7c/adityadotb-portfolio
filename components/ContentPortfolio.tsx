  ...
  return (
    <section className="border-b border-black">
      <div className="max-w-4xl mx-auto px-4 py-16 font-mono">
        <h2 className="text-2xl font-bold mb-4">{siteData.contentPortfolio.title}</h2>
        <p className="text-sm text-gray-700 mb-8">{siteData.contentPortfolio.description}</p>

        {siteData.contentPortfolio.articles.length === 0 ? (
          <div className="border border-dashed border-gray-400 p-8 text-center">
            <p className="text-gray-700">No articles yet. More coming soon.</p>
          </div>
        ) : (
